                    ...
                    if recno == 1:
                        ...
                        if rectype in ('Valtio', 'Country'):
                            ...
                            if result != None:
                                ...
                                country = get_place_from_handle(addPlace(priName, altNames, PlaceType.COUNTRY))
                            ...
                            if result != None:
                                ...
                                if rectype in ('Kunta', 'Municipality'): 
                                    municipality = get_place_from_handle(addPlace(priName, altNames, PlaceType.MUNICIPALITY, country))
                                else:
