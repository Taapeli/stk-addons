    ...
    def normalize(self, name, find_nearest=True, info=None,
        ...
        if len(name) == 0:
            ...
            if not find_nearest:
                ...
                nearest = None
                nearest_sim = -1
                for name2 in self.name_map.keys():
...
if __name__ == "__main__":
    ...
    name = 'Hintrikinpoika'
    print(u"\nExample #2a: patronyme to normalize: {}\n".format(name))
    normalized = patronym_normalizer.normalize(name)
    print(u"Normalized: {}\n".format(normalized))

    name = 'Pekanpoika'
    print(u"\nExample #2b: patronyme to normalize: {}\n".format(name))
    normalized = patronym_normalizer.normalize(name)
    print(u"Normalized: {}\n".format(normalized))

    name = u'Malmkvist'
    print(u"\nExample #3: last name to normalize: {}\n".format(name))
